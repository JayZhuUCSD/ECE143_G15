...
# -*- coding: utf-8 -*-
"""
Number of reviews for each developer
...
def main():
    ...
    df_Nreviews_developer= parseRatio_NreviewsAndDeveloper(df_with_all_ratio)
    df_Nreviews_developer.to_csv('df_Nreviews_developer.csv')
    display(df_Nreviews_developer)
